...
This repository serves as a baseline comparison and verification tool for Octal PSRAM initialization in a Rust / `esp-idf-sys` containerized environment, corresponding to the C reference project [`es-psram`](https://github.com/i-3/es-psram).
